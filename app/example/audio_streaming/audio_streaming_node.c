...
#define SAC_BACK_CHANNEL_CONSUMER_PAYLOAD_SIZE 60
#define SAC_BACK_CHANNEL_PRODUCER_PAYLOAD_SIZE 180
...
static void app_audio_core_init(sac_error_t *sac_err)
{
     ...
     *
     * +-----+    +----------------+    +-----+    +----------------+    +-------+
     * | SWC | -> | Digital Volume | -> | CDC | -> | Mute on Glitch | -> | Codec |
     * +-----+    +----------------+    +-----+    +----------------+    +-------+
     */
    ...
    volume_instance.bit_depth = SAC_MAIN_CHANNEL_BIT_DEPTH;
    ...
    mute_on_underflow_instance.reload_value = sac_get_nb_packets_in_x_ms(30,
                                                                         SAC_MAIN_CHANNEL_PAYLOAD_SIZE,
                                                                         SAC_MAIN_CHANNEL_NB_CHANNEL,
                                                                         SAC_MAIN_CHANNEL_BIT_DEPTH,
                                                                         SAC_MAIN_CHANNEL_SAMPLING_RATE);
