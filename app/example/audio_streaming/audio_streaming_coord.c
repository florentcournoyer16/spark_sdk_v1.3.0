 ...
 *         a 16 kHz mono stream. The use of the digital volume control, the
 *         sampling rate converter and the mute on glitch processing stages
 *         are demonstrated.
 *
...
#define SAC_MAIN_CHANNEL_NB_CHANNEL            2
#define SAC_MAIN_CHANNEL_LATENCY_QUEUE_SIZE    20
#define SAC_MAIN_CHANNEL_BIT_DEPTH             SAC_16BITS

#define SAC_BACK_CHANNEL_PRODUCER_PAYLOAD_SIZE 60
#define SAC_BACK_CHANNEL_CONSUMER_PAYLOAD_SIZE 180
#define SAC_BACK_CHANNEL_NB_CHANNEL            1
#define SAC_BACK_CHANNEL_LATENCY_QUEUE_SIZE    9
#define SAC_BACK_CHANNEL_SAMPLING_RATE         16000
#define SAC_BACK_CHANNEL_BIT_DEPTH             SAC_16BITS
...
static void app_audio_core_init(sac_error_t *sac_err)
{
    ...
    sac_endpoint_cfg_t max98091_producer_cfg = {
        ...
        .delayed_action     = true,
        .channel_count      = SAC_MAIN_CHANNEL_NB_CHANNEL,
        .bit_depth          = SAC_MAIN_CHANNEL_BIT_DEPTH,
     ...
     * Processing: Upsampling from 16 kHz to 48 kHz followed by clock drift compensation and mute on glitch.
     * Output:     Mono stream of 90 samples @ 48 kHz/16 bits is played using the MAX98091 hardware audio codec.
     *
     * +-----+    +---------------+    +----------------+    +-----+    +----------------+    +-------+
     * | SWC | -> | Upsampling 3x | -> | Digital Volume | -> | CDC | -> | Mute on Glitch | -> | Codec |
     * +-----+    +---------------+    +----------------+    +-----+    +----------------+    +-------+
     */
    sac_endpoint_cfg_t swc_producer_cfg = {
        .use_encapsulation  = true,
        .delayed_action     = false,
        .channel_count      = SAC_BACK_CHANNEL_NB_CHANNEL,
        .bit_depth          = SAC_BACK_CHANNEL_BIT_DEPTH,
    ...
    volume_instance.bit_depth = SAC_BACK_CHANNEL_BIT_DEPTH;
    ...
    mute_on_underflow_instance.reload_value = sac_get_nb_packets_in_x_ms(30,
                                                                         SAC_BACK_CHANNEL_CONSUMER_PAYLOAD_SIZE,
                                                                         SAC_BACK_CHANNEL_NB_CHANNEL,
                                                                         SAC_BACK_CHANNEL_BIT_DEPTH,
                                                                         SAC_BACK_CHANNEL_SAMPLING_RATE);
    ...
    sac_pipeline_add_processing(primary_sac_pipeline, mute_on_underflow_processing, sac_err);
